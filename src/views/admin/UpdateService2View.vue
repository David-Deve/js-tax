  ...
  <div>
    ...
    <Sidebar>
      <template v-slot:Content>
        ...
        >
          <h2 class="mb-5">Service2(Accounting Service)</h2>
...
async function getService2Paragrahp() {
  try {
    ...
    khpara2.value = res.data.bodies[4].descriptionKh;
    engpara2.value = res.data.bodies[4].descriptionEn;
    console.log(res);
  } catch (e) {
    console.log(e);
  }
