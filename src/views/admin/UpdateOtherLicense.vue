  ...
  <div>
    ...
    <Sidebar>
      <template v-slot:Content>
        ...
        >
          <h2 class="mb-5">Other License</h2>
...
async function getService1Paragrahp() {
  try {
    const res = await getOtherLicensePage();
...
async function updateService1Paragrahp() {
  ...
  try {
    ...
    const res = await updateOtherLicensePage(bodyPayloads);
    ElNotification({
      title: "Success",
      duration: 2000,
