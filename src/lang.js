const messages = {
  en: {
    ...
    contact: {
      ...
      email: "Email",
      phone: "Phone Number",
      locatime: "23Eo, Bayab, Phnom Penh Thmei, Sen Sok, Phnom Penh, Cambodia",
      time: "Monday-Friday 10:00am - 6:00pm",
      para: "Our mission is to provide exceptional financial services that empower our clients to make informed financial decisions, minimize tax liabilities, and achieve their financial goals. We are committed to delivering excellence and building lasting partnerships with our clients.",
    },
    other: {
      taxpayer: "TAXPAYER",
      documents: "Documents",
  ...
  kh: {
    ...
    contact: {
      ...
      email: "អ៊ីមែល",
      phone: "លេខទូរស័ព្ទ",
      locatime: "23Eo, បាយាប, ភ្នំពេញថ្មី, សែនសុខ, ភ្នំពេញ, កម្ពុជា",
      time: "ច័ន្ទ-សុក្រ ម៉ោង ១០:០០ ព្រឹក ដល់ ៦:០០ ល្ងាច",
      para: "បេសកកម្មរបស់យើងគឺផ្តល់សេវាកម្មហិរញ្ញវត្ថុពិសេសដែលផ្តល់សិទ្ធិអំណាចដល់អតិថិជនរបស់យើងដើម្បីធ្វើការសម្រេចចិត្តផ្នែកហិរញ្ញវត្ថុដែលមានព័ត៌មាន កាត់បន្ថយបំណុលពន្ធ និងសម្រេចបាននូវគោលដៅហិរញ្ញវត្ថុរបស់ពួកគេ។ យើងប្តេជ្ញាក្នុងការផ្តល់នូវភាពល្អឥតខ្ចោះ និងការកសាងភាពជាដៃគូយូរអង្វែងជាមួយអតិថិជនរបស់យើង។",
    },
    other: {
